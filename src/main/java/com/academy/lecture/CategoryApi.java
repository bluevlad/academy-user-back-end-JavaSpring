...
public class CategoryApi extends CORSFilter {
    ...
    public JSONObject getSeriesSubject(
            @ModelAttribute("CategoryVO") CategoryVO categoryVO) throws Exception {
        ...
        params.put("CATEGORY_CD", CommonUtil.isNull(categoryVO.getSearchCategoryCode(), CommonUtil.isNull(categoryVO.getTopMenu(), "001")));
